...
int joystickX = 2;  // analog pin used to measure the joystick value
...
void loop() 
{ 
  val = analogRead(joystickX);            // reads the value of the joystick (value between 0 and 4096) 
  val = map(val, 0, 4085, 0, 179);     // scale it to use it with the servo (value between 0 and 180) 
